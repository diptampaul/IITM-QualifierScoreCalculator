import tabula
k=tabula.read_pdf("POD20Q1QP2S21380245.pdf",pages="all")
...
for i in range(len(array)):
    if (i==50 and code==3) or (i==47 and code==1) or (i==42 and code==2):
        engcount=count
    if (i==64 and code==3) or (i==61 and code==1) or (i==55 and code==2):
        ctcount=count-engcount
    if (i==87 and code==3) or (i==83 and code==1) or (i==78 and code==2):
    ...
    if q[i][3]==0:
        ...
        for j in array[i][1]:
            ...
            count+=float(q[i][2])*float(len(array[i][1]))/float(len(q[i][1]))
            continue
    elif q[i][3]==2:
           q[i][1]=q[i][1].strip("'[]'")
           q[i][1]=q[i][1].split(",")
